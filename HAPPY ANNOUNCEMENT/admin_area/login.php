...
<body>
   ...
   <div class="container"><!-- container begin -->
       <form action="" class="form-login" method="post"><!-- form-login begin -->
           <h2 class="form-login-heading"> Admin Connexion </h2>
...
<?php 
    ...
    if(isset($_POST['admin_login'])){
        ...
        $admin_email = mysqli_real_escape_string($coon,$_POST['admin_email']);
        
        $admin_pass = mysqli_real_escape_string($coon,$_POST['admin_pass']);
