...
include("include/Db_conf.php");
 // assuming the MedecinDAO class is defined in MedecinDAO.php
 include("include/ProductDoa.php");
 $productDoa = new ProductDoa($pdo);
$idedit=$_GET['idedit'];
$editepro=$productDoa->getByeID($idedit);
    ...
    <form action="" method="post" enctype="multipart/form-data">
      ...
      <?php
        ...
        <li class="form-group ">
          ...
          <input class="form-control" type="text" name="name" id="nom" value="<?php echo $editepro->getProName();?>" required>
        </li>

        <li class="form-group ">
          <label for="imge1">Image:</label>
          <img src="../img_pro/<?php echo $editepro->getProImg1(); ?>" class="img-fluid" style="width: 100px;">

          <input type="file" name="imge1" id="imge1" value="Image" required>
          <img src="../img_pro/<?php echo $editepro->getProImg2(); ?>" class="img-fluid" style="width: 100px;">
        ...
        <li class="form-group ">
          <div class="row">
            <div class="col-md-6">
              ...
              <input class="form-control" type="number" name="Quantity" id="Quantity" value="<?php echo $editepro->getPro_qute()?>" required>
            </div>
            <div class="col-md-6">
              <label for="Price">Price:</label>
              <input class="form-control" type="number" name="Price" id="Price" value="<?php echo $editepro->getProPrise()?>">
            </div>
          </div>
        </li>
        ...
        <li class="form-group ">
          <div class="row">
            <div class="col-md-6">
              ...
              <textarea class="form-control" name="Description" id="Description" value="<?php echo $editepro->getProDes()?>"></textarea>
            </div>
            <div class="col-md-6">
              <label for="Price2">PriceOld:</label>
              <input class="form-control" type="number" name="PriceOld" id="Price2" value="<?php echo $editepro->getProPriseOld()?>">
            </div>
          </div>
        </li>
        ...
        <li class="form-group ">
          <div class="row">
            <div class="col-md-6">
              ...
              <input class="form-control" type="text" name="Keywords" id="Keywords" value="<?php echo $editepro->getProKeywored()?>">
            </div>
            <div class="col-md-6">
              <label for="Place">Place:</label>
              <input class="form-control" type="text" name="Place" id="Place" value="<?php echo $editepro->getProPlase()?>">
            </div>
          </div>
        </li>
...
if (isset($_POST['supmate'])) {
  ...
  $productDoal = new ProductDoa($pdo);
  ...
  $id_admin,
  $id_custem);
  $productDoa->update($product,$idedit);
}?>